...
use function dmitryeskin1\guess_number\View\startGame;
use function dmitryeskin1\guess_number\View\showList;
use function dmitryeskin1\guess_number\View\showReplays;
use function dmitryeskin1\guess_number\View\showTopRating;
